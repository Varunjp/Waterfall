...
func (x *UserPlan) Reset() {
	*x = UserPlan{}
	mi := &file_proto_app_user_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserPlan) Descriptor() ([]byte, []int) {
	return file_proto_app_user_proto_rawDescGZIP(), []int{15}
}
...
func (x *ListPlansResponse) Reset() {
	*x = ListPlansResponse{}
	mi := &file_proto_app_user_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPlansResponse) Descriptor() ([]byte, []int) {
	return file_proto_app_user_proto_rawDescGZIP(), []int{16}
}
...
func (x *UpdateUserStatusRequest) Reset() {
	*x = UpdateUserStatusRequest{}
	mi := &file_proto_app_user_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateUserStatusRequest) Descriptor() ([]byte, []int) {
	return file_proto_app_user_proto_rawDescGZIP(), []int{17}
}
