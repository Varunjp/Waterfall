...
import (
	...
	"admin_service/internal/metrics"
...
func main() {
	...
	if cfg.Metrics.Enabled {
		go func() {
			if err := metrics.RunServer(ctx, ":"+cfg.Metrics.Port); err != nil {
	...
	grpcServer := grpc.NewServer(grpc.ChainUnaryInterceptor(
		adminMetrics.UnaryServerInterceptor(),
	...
	r := chi.NewRouter()
	r.Use(adminMetrics.HTTPMiddleware)
